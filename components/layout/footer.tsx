    ...
    return (
        <Style>
                    ...
                    <div className="box">
                        ...
                        <div className="column_third">
                            <ul>
                                ...
                                <li><Link href=""><a className="p16-regular">Prmomoções</a></Link></li>
            ...
            <div className="rodape">
                <div className="container">
                    <span className="p12-400">Von Cervejaria CNPJ: 23.187.379.0001/96</span>
                    <span className="p12-400">Rua Santos, 1321. Londrina-PR</span>
                    <span className="p12-400">2022 / Marca registrada</span>
